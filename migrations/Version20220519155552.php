 ...
 */
final class Version20220519155552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE support_question (id INT AUTO_INCREMENT NOT NULL, name LONGTEXT NOT NULL, url LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE internet_advantages CHANGE region region LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE news CHANGE name name VARCHAR(1024) NOT NULL, CHANGE short_description short_description VARCHAR(10000) DEFAULT NULL, CHANGE description description VARCHAR(10000) DEFAULT NULL, CHANGE image image VARCHAR(4096) DEFAULT NULL, CHANGE date date VARCHAR(1024) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE region CHANGE internet_warning internet_warning LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE internet_advantages CHANGE region region TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE news CHANGE name name TEXT NOT NULL, CHANGE short_description short_description TEXT DEFAULT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE image image TEXT DEFAULT NULL, CHANGE date date TINYTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE region CHANGE internet_warning internet_warning TEXT DEFAULT NULL');
    }
}
